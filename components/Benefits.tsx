  ...
  const benefits = [
    {
      ...
      description: "אנחנו לוקחים אחריות מלאה על כל היבטי הבניין: מניקיון וגינון שוטף, דרך מערכות מורכבות ועד ליווי פרויקטים של שיפוץ ותיקונים יסודיים. הכל תחת קורת גג אחת",
      icon: <ShieldCheck size={28} strokeWidth={1.5} />
    },
    {
      title: "תחזוקה מונעת",
      description: "אל תחכו לתקלה. אנחנו מנהלים עבורכם תוכנית עבודה שנתית קפדנית, שמונעת שחיקה של המבנה וחוסכת לכם הוצאות כבדות ומיותרות בעתיד.",
